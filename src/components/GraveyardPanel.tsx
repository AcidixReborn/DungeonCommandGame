...
function GraveyardPanel({
  ...
  const graveyardCreatures = selectedPlayer
    ? gameState.getGraveyardCreatures(selectedFactionId)
    : []
  ...
  const canResurrectFromHere =
    isOwnGraveyard && isDeployPhase && isHumanTurn && hasResurrectableCreatures
  ...
  return (
    <div className="combat-panel graveyard-panel">
      ...
      <div
        className="graveyard-creatures-grid"
        style={{
          display: 'flex',
          flexWrap: 'wrap',
          gap: '8px',
      ...
      >
        {graveyardCreatures.length === 0 ? (
          ...
          graveyardCreatures.map((creature, idx) => {
            ...
            const canAffordResurrection =
              canResurrectFromHere && gameState.canResurrectCreature(currentPlayerId, creature)
            ...
            return (
              <div
                ...
                draggable={
                  canResurrect && canResurrectFromHere && canAffordResurrection && isSelected
                }
                onDragStart={(e) => {
                  if (
                    canResurrect &&
