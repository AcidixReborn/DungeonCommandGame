...
function GameBoard({ onTurnInfoChange }) {
  ...
  // CLOUD OF BATS shift handlers (post-defense reposition) - extracted hook.
  // Placed here (not with the other extracted hooks near the top) because it
  // depends on executeAttackAfterDefense, a plain function defined just above -
  // the call site needs it already assigned, unlike a deferred closure.
  const {
